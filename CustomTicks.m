...
(* :Copyright: Copyright 2008, Mark A. Caprio *)
...
*)
(* Acknowledgements for bug reports and suggestions: Johannes Grosse, Will Robertson *)
...
Options[LogTicks]={ExtraTicks->{},TickPreTransformation->Identity,TickPostTransformation->Identity,ShowFirst->True,ShowLast->True,ShowTickLabels->True,ShowMinorTicks->True,TickLabelStart->0,TickLabelStep->1,TickRange->{-Infinity,Infinity},TickLabelRange->{-Infinity,Infinity},DecimalDigits->Automatic,MajorTickLength->{0.010,0},MinorTickLength->{0.005,0},MajorTickStyle->{},MinorTickStyle->{},MinorTickIndexRange->{1,Infinity}};
